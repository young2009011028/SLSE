...
namespace SubstationLSE
{
    public class TransmissionLine
    {
        ...
        private CurrentPhasorGroup m_lineCurrent;
        private string m_lineCurrentID; 
        ...
        [XmlElement("LineCurrent")]
        public CurrentPhasorGroup LineCurrent
        {
            get
            {
            ...
            {
                m_lineCurrent = value;
                m_lineCurrentID = value.InternalID;
                m_lineCurrent.MeasuredNode = this.m_connectedNode;
            }
        }
